...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private Typeface tabTypefaceStyle = Functions.getTypeface("Roboto-Light");
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        //tabTypefaceStyle = a.getInt(R.styleable.PagerSlidingTabStrip_pstsTextStyle, Functions.getTypeface("tabTypefaceStyle"));
    ...
    private void notSelected(View tab) {
        if (tab != null) {
            ...
            if (title != null) {
                title.setTypeface(Functions.getTypeface("Roboto-Light"));
    ...
    public void setTypeface(Typeface typeface, Typeface typeface2) {
        Typeface tabTypefaceSelectedStyle = Functions.getTypeface("Roboto-Light");
        this.tabTypeface = typeface;
        tabTypefaceSelectedStyle = typeface2;
        updateTabStyles();
    }
